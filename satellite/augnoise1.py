...
# path = 'D:/satelitte/noise-1'
# auginputpath = 'D:/satelitte/augnoise1' 
# movepath = 'D:/satelitte/noise1move'
...
# 	with open('listfile4.data', 'wb') as filehandle:
...
total = placesList+placesList2+placesList3+placesList4

labelpath = 'D:/satelitte/notnoise1'
auglabelpath = 'D:/satelitte/augnotnoise1'
movepath2 = 'D:/satelitte/notnoise1move'

j=290
for images in tqdm(os.listdir(labelpath)):
	image = os.path.join(labelpath, images)
	s = image.split('/')[-1] [9:].split('.')[0]
